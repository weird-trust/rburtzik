...
declare module '$env/static/private' {
	...
	export const VITE_CLOUDINARY_API_KEY: string;
	export const VITE_CLOUDINARY_API_SECRET: string;
	export const VITE_SCREENSHOTMACHINE_API_KEY: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		VITE_SCREENSHOTMACHINE_API_KEY: string;
